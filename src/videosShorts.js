...
export async function getVideoShortsData() {
  ...
  if (get(yearShowing) === 2024)
    URL =
      'https://docs.google.com/spreadsheets/d/e/2PACX-1vTj67l2D7wfqIr28Hx0eMvmXHMaMFxdqwL7yI3H-PoXvzfop0qHkPxaUT0RFCkGl0qqRrVMNbDuqgGa/pub?gid=857104437&single=true&output=csv'
  // if year is 2023
  else
    URL =
